...
- [Быстрый старт](#быстрый-старт)
  ...
  - [Ввод/вывод слов (последовательность байт без пробелов)](#вводвывод-слов-последовательность-байт-без-пробелов)
  ...
  - [Ввод/вывод значений разных типов `ScanAny` / `PrintAny`](#вводвывод-значений-разных-типов-scanany--printany)
  - [Как избежать лишних аллокаций в `PrintAny`?](#как-избежать-лишних-аллокаций-в-printany)
...
```
**Ограничение**: при сканировании длина токена не может превышать размер внутреннего буфера (по умолчанию 4КБ) минус один символ.
...
Больше примеров можешь найти в [github.com/aaa2ppp/ya-algo-training9-pub](https://github.com/aaa2ppp/ya-algo-training9-pub/blob/master/README.md).
