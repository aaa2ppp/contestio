...
- [Быстрый старт](#быстрый-старт)
  ...
  - [Ввод/вывод значений разных типов одним вызовом](#вводвывод-значений-разных-типов-одним-вызовом)
...
### Ввод/вывод значений разных типов одним вызовом
...
> `PrintAny` принимает как значения, так и указатели. Но в первом случае, из-за особенности реализации интерфейсов в Go,
> будут аллокации (значение убегает на кучу).
